...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), u1); //passando o client ele mesmo faz a associação dos objetos
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), u2); //na classe pedido tem um atributo do tipo User
